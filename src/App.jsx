  ...
  return (
    <>
      ...
      <section className="container">
        ...
        <div className="build py-5 w-100 text-center lh-1 d-flex flex-column align-items-center my-3 rounded-5" style={{backgroundColor:"url('./assets/images/background.png')"}}>
